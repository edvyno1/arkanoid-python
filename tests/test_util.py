...
class TestUtil(TestCase):
    ...
    def setUp(self):
        self._high_score_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                             '../.arkanoid')
        self._high_score_file_backup = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                                    '../.arkanoid.bak')
    ...
    def tearDown(self):
        ...
        #     os.remove(self._high_score_file_backup)
